...
class BaseAdderConfig(BaseExperimentConfig):
    def __init__(self):
        super().__init__()
        self.description = "Base config for Adder dataset"
    ...
    def _data_setting(args):
        ...
        args.adder_format_vocab = {'=': args.math_vocab['='], '+': args.math_vocab['+']} if args.adder_use_format else None
        return args
...
class AdderSFTConfig(BaseAdderConfig):    
...
class AdderRLConfig(BaseAdderConfig):
    def __init__(self, model):
        super().__init__()
        self.description = "RL training for NanoGPT model on Adder dataset"
        self.model = model
    ...
    def get_args_ready(self):
        ...
        # IO setting
        args.wandb_project = 'RL-GPT'
        args.exp_name = f'AdderRL({args.adder_ndigit}_format)' if args.adder_use_format else f'AdderRL({args.adder_ndigit})'
        args.exp_profile = f'{args.exp_name}_{args.model}_{args.n_position}_{args.n_embed}_{args.n_head}_{args.n_layer}'
