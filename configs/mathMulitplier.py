...
class MultiplierNanoGPTConfig(BaseExperimentConfig):    
    def __init__(self):
        super().__init__()
    ...
    def get_args_ready(self):
        ...
        args.multiplier_format_vocab = {'=': args.math_vocab['='], '+': args.math_vocab['+']}
...
class MultiplierLlamaConfig(BaseExperimentConfig):    
    def __init__(self):
        super().__init__()
        self.description = "llama model trained on Multiplier dataset"
