...
class ShakespeareNanoGPTConfig(BaseExperimentConfig):
    ...
    def __init__(self):
        super().__init__()
        self.description = "Small NanoGPT model trained on Shakespeare character-level dataset"
    ...
    def get_args_ready(self):
        ...
        args.dropout_attn = 0.0                     # training from scratch or resuming from latest snapshot within out-dir
        args.init_from = None
